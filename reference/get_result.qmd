# get_result { #wordguess.get_result }
...
| Name | Description |
| --- | --- |
| [get_result](#wordguess.get_result.get_result) | Generate a guess feedback for a given guess against a target word. |

### get_result { #wordguess.get_result.get_result }
